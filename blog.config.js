...
const BLOG = {
  ...
  APPEARANCE_DARK_TIME: process.env.NEXT_PUBLIC_APPEARANCE_DARK_TIME || [18, 6], // 夜间模式起至时间，false时关闭根据时间自动切换夜间模式ture
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'wofa', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '窝法', // 作者简介
  ...
  POSTS_SHARE_SERVICES:
    ...
    'link,wechat,qq,weibo,email,twitter,telegram,messenger,line', // 分享的服務，按顺序显示,逗号隔开
